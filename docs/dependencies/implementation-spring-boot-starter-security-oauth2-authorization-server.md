# implementation - spring-boot-starter-security-oauth2-authorization-server
...
RegisteredClientRepository registeredClientRepository() {
    RegisteredClient client = RegisteredClient.withId("example-client")
            .clientId("client")
...
- artifact: spring-boot-starter-security-oauth2-authorization-server
