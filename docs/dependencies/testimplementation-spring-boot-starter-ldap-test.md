# testImplementation - spring-boot-starter-ldap-test
...
이 의존성은 spring-boot-starter-ldap-test 기능을 테스트 코드에서 검증하기 위한 테스트 전용 의존성이다.
...
- artifact: spring-boot-starter-ldap-test
