# implementation - spring-boot-starter-ldap
...
public class LdapSearchService {
    ...
    public boolean existsUser(String username) {
        return !ldapTemplate.search("ou=people", "(uid=" + username + ")", attrs -> username).isEmpty();
    }
}
~~~
...
- artifact: spring-boot-starter-ldap
